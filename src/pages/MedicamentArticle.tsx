...
const articleContent = {
  fr: {
    ...
    content: {
      ...
      subtitle3: "L'accompagnement de Nexia Morocco",
      paragraph5: "Face à ces défis, Nexia Morocco accompagne les acteurs du secteur – industriels, investisseurs, décideurs publics – dans la conception et la mise en œuvre de solutions adaptées. Notre expertise couvre l'optimisation de la chaîne d'approvisionnement, la structuration de projets d'investissement, la mise en place de stratégies fiscales et réglementaires, ainsi que le développement de modèles de financement innovants.",
