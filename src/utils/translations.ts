...
export const translations = {
  fr: {
    ...
    'facts.moroccoProfessionals': 'Professionnels',
    'facts.moroccoClients': 'Clients accompagnés',
    'facts.moroccoOffices': 'Bureaux au Maroc',
    'facts.intlLabel': 'Nexia International',
    'facts.intlTagline': 'Réseau global, 5 continents',
    'facts.intlRevenue': 'USD de revenus réseau',
    'facts.intlRank': 'Réseau mondial (CA)',
    'facts.intlFirms': 'Cabinets membres',
    'facts.intlCountries': 'Pays couverts',
    'facts.intlOffices': 'Bureaux dans le monde',
    'facts.intlContinents': 'Continents',
    'facts.intlProfessionals': 'Professionnels',
    'facts.intlPartners': 'Associés',
    
    // Our Services Menu
    'servicesMenu.excellenceTitle': 'Excellence & Expertise',
    'servicesMenu.title': 'Explorer nos expertises en détail',
    'servicesMenu.description': 'Sélectionnez un domaine ci-dessous pour découvrir notre approche, nos services et notre expérience.',
    ...
    // Footer — disclaimer officiel Nexia (Website Guidelines 2023, p.26)
    'footer.tagline': 'Audit · Expertise comptable · Conseil',
    'tagline.global': 'Connexions personnelles, solutions globales.',
    'sectors.eyebrow': 'Secteurs',
    'sectors.title': "Une expertise sectorielle au service de votre activité",
    'sectors.description': "Nos équipes interviennent dans les secteurs clés de l'économie marocaine et internationale.",
    'sectors.financial': 'Services financiers & Banque',
    'sectors.tech': 'Technologies & Digital',
    'sectors.industry': 'Industrie & Manufacturing',
    'sectors.realestate': 'Immobilier & Construction',
    'sectors.health': 'Santé & Pharmaceutique',
    'sectors.services': 'Services aux entreprises',
  ...
  en: {
    ...
    'facts.moroccoProfessionals': 'Professionals',
    'facts.moroccoClients': 'Clients served',
    'facts.moroccoOffices': 'Offices in Morocco',
    'facts.intlLabel': 'Nexia International',
    'facts.intlTagline': 'Global network, 5 continents',
    'facts.intlRevenue': 'USD network revenue',
    'facts.intlRank': 'Global ranking (revenue)',
    'facts.intlFirms': 'Member firms',
    'facts.intlCountries': 'Countries covered',
    'facts.intlOffices': 'Offices worldwide',
    'facts.intlContinents': 'Continents',
    'facts.intlProfessionals': 'Professionals',
    'facts.intlPartners': 'Partners',
    
    // Our Services Menu
    'servicesMenu.excellenceTitle': 'Excellence & Expertise',
    'servicesMenu.title': 'Explore our expertise in detail',
    'servicesMenu.description': 'Select a domain below to discover our approach, services and experience.',
    ...
    // Footer — official Nexia disclaimer (Website Guidelines 2023, p.26, verbatim)
    'footer.tagline': 'Audit · Accounting · Advisory',
    'tagline.global': 'Personal connections, global solutions.',
    'sectors.eyebrow': 'Sectors',
    'sectors.title': "Industry expertise tailored to your business",
    'sectors.description': "Our teams work across the key sectors of the Moroccan and international economy.",
    'sectors.financial': 'Financial Services & Banking',
    'sectors.tech': 'Technology & Digital',
    'sectors.industry': 'Industry & Manufacturing',
    'sectors.realestate': 'Real Estate & Construction',
    'sectors.health': 'Health & Pharmaceutical',
    'sectors.services': 'Business Services',
